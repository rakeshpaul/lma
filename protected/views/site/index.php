...
<div id="header">
    ...
    <div class="page-full-width cf">
        ...
        <a href="#" id="company-branding" class="fr"><img src="images/company-logo.png" alt="Alfine Solutions" /></a>
...
<div id="content">
    ...
    <form action="#" method="POST" id="login-form">
        ...
        <fieldset>
            ...
            <a href="#" class="button round blue image-right ic-right-arrow">LOG IN</a>
        </fieldset>
    </form>
